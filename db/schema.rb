...
ActiveRecord::Schema.define(version: 20160714164513) do
  ...
  create_table "businesses", force: :cascade do |t|
    ...
    t.string   "name"
    t.date     "exp_date"
    t.integer  "boxes_checked_in"
    t.integer  "boxes_checked_out"
    t.integer  "boxes_supplied"
    t.integer  "boxes_inventory"
